  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 glass border-r border-white/[0.06] flex flex-col z-40">
      ...
      <div className="h-16 flex items-center gap-3 px-6 border-b border-white/[0.06]">
        ...
        <div>
          <h1 className="text-sm font-semibold text-white tracking-tight">Admin Panel</h1>
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto admin-scroll">
        <p className="text-[10px] font-medium text-zinc-500 uppercase tracking-wider px-3 mb-3">
          Menu
        </p>
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 group ${
                isActive
                  ? "bg-gradient-to-r from-indigo-500/10 to-purple-500/5 text-indigo-400 shadow-lg shadow-indigo-500/5"
